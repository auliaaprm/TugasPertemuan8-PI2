  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="pinjam.php">Data Pinjam</a>
        </li>
        <li class="nav-item">
...
<div class="container">
        ...
        <br>
        <a href="create_pinjam.php"><input type="button" value="Tambah Data"/></a> &nbsp;
        <a href="print_pinjam.php" target="_blank"><input type="button" value="Cetak Data"/></a>
        <br>
        <br>
        <table class="table table-hover" border="1">
            ...
            <tbody>
                <?php
                $result = $model->tampil_data_pinjam();
                if (!empty($result)) {
                    foreach ($result as $data) : ?>
                        <tr>
                            ...
                            <td>
                                <a name="edit" id="edit" href="edit_pinjam.php?id=<?= $data->id_pinjam ?>"><input type="button" value="Edit"/></a>
                                <a name="hapus" id="hapus" href="process.php?pinjam_id=<?= $data->id_pinjam ?>"><input type="button" value="Delete"/></a>
                            </td>
                        </tr>
                    <?php endforeach;
                } else { ?>
